...
<?php if($konektatua==1){
  echo '
      <div class="formularioa">
          ...
          echo "<form id='galderenF' name='galderenF' action='AddQuestionWithImage.php?eposta=$eposta' onsubmit='return validateForm()' method='post' enctype='multipart/form-data'>";
