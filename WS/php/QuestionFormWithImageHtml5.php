...
<?php if($konektatua==1){
  echo '
      <div class="formularioa">
            ...
            echo "<form id='formularioa' name='formularioa' action='AddQuestionWithImage.php?eposta=$eposta' onsubmit='return validateForm()' method='post' enctype='multipart/form-data'>";
